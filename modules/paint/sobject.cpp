...
QString SObject::typeString(PaintObject type)
{
    switch (type)
    {
    case sgis::ObjectBase:
        return "Object Base";
        break;
    case sgis::ShapeBase:
        return "Shape Base";
    ...
    case sgis::PointFeature:
        ...
        break;
    case sgis::LineStringFeature:
        return "Line String Feature";
        break;
    case sgis::PolygonFeature:
        return "Polygon Feature";
        break;
    case PaintObject::FeatureBase:
        return "Feature Base";
        break;
    }
}
